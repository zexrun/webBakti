...
>
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('admin.monitoring.index') }}" class="icon-button">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="icon-svg"
                        viewBox="0 0 24 24"
            ...
            <li>
                <a href="{{ route('admin.settings.index') }}" class="icon-button">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="icon-svg"
                        viewBox="0 0 24 24"
                ...
                <div class="bg-gray-50 rounded-lg p-3">
                    ...
                    >
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">{{
                                $adminStats["total_supervisors"]
                            }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Magang Aktif:</span>
                            <span class="font-medium text-green-600">{{
                                $adminStats["active_internships"]
                            }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span>Belum Plotting:</span>
                            <span class="font-medium text-red-600">{{
                                $adminStats["pending_plotting"]
                            }}</span>
                        </div>
                    </div>
                </div>
