            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="bg-gray-50 p-4 border-b border-gray-200">
                    ...
                    <a href="{{ route('supervisor.pdf.grade', $student->id) }}"
                       class="inline-block mt-2 bg-green-700 hover:bg-green-800 text-white text-sm font-medium px-5 py-2.5 rounded-lg focus:outline-none focus:ring-4 focus:ring-green-300">
                        Cetak Nilai
                    </a>
                </div>
                ...
                <div class="overflow-x-auto">
                            ...
                            <tbody class="text-gray-700">
                                @foreach($student->tasks as $task)
                                    <tr class="border-t border-gray-100 hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            <span class="inline-block bg-blue-100 text-blue-800 px-2 py-1 text-xs rounded-full">
                                                {{ ucfirst($task->type) }}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4">
                    ...
                    @else
                        <p class="text-center text-gray-500 italic py-6">
                            Belum ada tugas yang diberikan untuk mahasiswa ini.
                        </p>
                    @endif
                </div>
            </div>
