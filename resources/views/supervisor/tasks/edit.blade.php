    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-4">
                <a href="{{ route('supervisor.tasks.show', $task) }}" class="mr-4 p-2 text-gray-400 hover:text-gray-600 transition-colors">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Perbarui detail tugas di bawah ini</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="p-6">
                ...
                <form action="{{ route('supervisor.tasks.update', $task) }}" method="POST" enctype="multipart/form-data" id="taskForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description"
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none">{{ old('description', $task->description) }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="type"
                                    ...
                                    <option value="harian" {{ old('type', $task->type) == 'harian' ? 'selected' : '' }}>Tugas Harian</option>
                                    <option value="akhir" {{ old('type', $task->type) == 'akhir' ? 'selected' : '' }}>Laporan Akhir</option>
                                </select>
                            </div>
                                ...
                                <div class="mt-3 p-3 bg-green-50 border border-green-200 rounded-md">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-green-900">{{ basename($task->file_path) }}</p>
                                                <p class="text-xs text-green-600">File terlampir saat ini</p>
                                            </div>
                                        </div>
                                        <span class="text-xs text-green-600">Ganti dengan file baru jika diperlukan</span>
                                    </div>
                                </div>
                            @endif
