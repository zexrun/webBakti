@extends('layouts.app') @section('title', 'Informasi Magang Saya')
@push('scripts')
<script>
            ...
            <div class="space-y-6">
                ...
                >
                    ...
                    <div
                        ...
                        x-transition
                        class="absolute z-10 mt-2 w-full bg-white border border-gray-200 rounded-md shadow-lg max-h-64 overflow-auto"
                    >
                        <!-- Search input -->
                ...
                {{-- Di dalam file edit.blade.php, di bagian bawah form --}}
                <div class="bg-white p-8 rounded-lg shadow-md mt-6">
                    ...
                    $student->finalAssessment->certificate_generated_at)
                    {{-- Jika sertifikat sudah dibuat, tampilkan tombol download --}}
                    <p class="text-gray-600 mb-4">
                        Selamat! Sertifikat kelulusan magang Anda sudah tersedia
                        untuk diunduh.
                    </p>
                    <a
                    ...
                    <p class="text-gray-500">
                        Sertifikat Anda akan tersedia di sini setelah pembimbing
                        selesai melakukan penilaian akhir dan men-generate
                        sertifikat.
                    </p>
                    @endif
                </div>
