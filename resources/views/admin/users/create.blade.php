    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-600 mt-1">Masukkan data pengguna yang akan dibuat</p>
            </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    @enderror
                    <p class="mt-1 text-sm text-gray-500">Email akan digunakan untuk login dan aktivasi akun</p>
                </div>
                ...
                <!-- Role Description -->
                <div id="roleDescription" class="hidden p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <div class="flex">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-3">
                            <h4 class="text-sm font-medium text-blue-800" id="roleTitle"></h4>
                            <p class="text-sm text-blue-700 mt-1" id="roleText"></p>
                        </div>
                    </div>
                </div>
...
roleSelect.addEventListener('change', function() {
    ...
    if (selectedRole && roleDescriptions[selectedRole]) {
        ...
        roleText.textContent = roleDescriptions[selectedRole].text;
