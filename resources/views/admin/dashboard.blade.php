        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center mt-1">
                            ...
                            <span class="text-xs text-yellow-600 font-medium">Dalam Progress</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <p class="text-sm font-medium text-gray-500">Pertemuan Hari Ini</p>
                        <p class="text-2xl font-bold text-gray-900">{{ $todayMeetings ?? 0 }}</p>
                        <div class="flex items-center mt-1">
                            <svg class="w-3 h-3 text-purple-500 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                            <span class="text-xs text-purple-600 font-medium">Dijadwalkan</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center space-x-2">
                            <button class="px-3 py-1.5 text-sm text-gray-600 hover:text-gray-900 border-b-2 border-blue-500">Bulanan</button>
                            <button class="px-3 py-1.5 text-sm text-gray-600 hover:text-gray-900">Mingguan</button>
                            <button class="px-3 py-1.5 text-sm text-gray-600 hover:text-gray-900">Harian</button>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 flex-1">
                                <p class="text-sm text-gray-900">Mahasiswa baru terdaftar</p>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 flex-1">
                                <p class="text-sm text-gray-900">Pertemuan selesai dilaksanakan</p>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 flex-1">
                                <p class="text-sm text-gray-900">Tugas baru dibuat</p>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 flex-1">
                                <p class="text-sm text-gray-900">Pertemuan dijadwalkan</p>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Mahasiswa',
                    data: [12, 19, 15, 25, 22, 30, 28, 35, 32, 40, 38, {{ $studentCount }}],
                    borderColor: '#3B82F6',
                ...
                {
                    label: 'Pembimbing',
                    data: [5, 8, 7, 10, 9, 12, 11, 15, 13, 18, 16, {{ $supervisorCount }}],
                    borderColor: '#10B981',
                ...
                {
                    label: 'Pertemuan',
                    data: [8, 15, 12, 20, 18, 25, 22, 30, 28, 35, 32, 40],
                    borderColor: '#8B5CF6',
