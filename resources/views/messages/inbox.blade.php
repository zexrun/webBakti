...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600">{{ $unreadCount }} pesan baru</p>
        </div>
    ...
    <div class="flex gap-4 mb-6 border-b border-gray-200">
        <a href="{{ route('messages.inbox') }}" class="px-4 py-2 border-b-2 border-blue-600 text-blue-600 font-medium">
            Inbox
        </a>
        <a href="{{ route('messages.sent') }}" class="px-4 py-2 border-b-2 border-transparent text-gray-600 hover:text-gray-900 font-medium">
            Terkirim
        </a>
    </div>
    ...
    <div class="space-y-2">
        ...
        @empty
            <div class="bg-white rounded-lg p-12 text-center border border-gray-200">
                <p class="text-gray-600">Inbox kosong</p>
            </div>
        @endforelse
    </div>
